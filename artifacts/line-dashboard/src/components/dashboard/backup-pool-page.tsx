      ...
      return (
        <div className="space-y-2">
          {pending.map((line) => (
            <div
              key={line.id}
              className="relative bg-amber-500/5 border border-amber-500/20 rounded-xl px-4 py-3"
            >
              {/* Trash — absolute top-right */}
              <button
                type="button"
              ...
              <div className="pr-10 space-y-1.5">
                ...
                <div className="pt-1">
                  <Button
                    ...
                    className="rounded-lg bg-amber-500/15 text-amber-400 hover:bg-amber-500/25 border border-amber-500/20 gap-1.5 h-7 text-xs px-2.5"
                    variant="ghost"
                  >
                    กำหนดเว็บ
